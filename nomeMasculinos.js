...
function mostrarTotalidade() { 

function randomizarNomeH(array){
...
let nomeSorteado2 = randomizarNomeH(nomesMasculinos);

document.getElementById("demonstracao").innerHTML = nomeSorteado2;
